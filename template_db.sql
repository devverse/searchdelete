...
CREATE TABLE IF NOT EXISTS `fullrecords` (
  ...
  `specialexperince` varchar(180) NOT NULL,
  `adacapabilities` varchar(180) NOT NULL,
  `certifications` varchar(150) NOT NULL,
  `culturalcompetancy` varchar(10) NOT NULL,
  `publictransavailable` varchar(10) NOT NULL,
  ...
  `latitude_str` varchar(20) NOT NULL,
  `longitude_str` varchar(20) NOT NULL,
